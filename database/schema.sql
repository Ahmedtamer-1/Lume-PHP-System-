...
CREATE TABLE `orders` (
  ...
  `status`          ENUM('pending','pending_payment','payment_uploaded','paid','processing','shipped','delivered','cancelled','refunded') NOT NULL DEFAULT 'pending',
  ...
  `instapay_receipt` VARCHAR(255) DEFAULT NULL,
